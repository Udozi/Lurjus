...
haaste1 = Haaste("palkkiometsästäjä","Palkkiometsästäjä","nostopakkaan sekoitetaan",str(15 + math.floor(Muuttujat.vaikeusaste)) + " suuruinen vihollinen.")
...
haaste7 = Haaste("ahtaatHuoneet", "Ahtaat huoneet", "huoneen koko on", "3 korttia.")
